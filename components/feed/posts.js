      ...
      <Box className={classes.postHeader}>
        ...
        <Box className={classes.headerRight}>
          ...
          <Box className={classes.headerIcon}>
            ...
            >
              <g fill="none" fill-rule="evenodd">
                <g fill="#3E4152" stroke="#3E4152" stroke-width=".2">
                  <g>
                    <g>
                      <path
                        d="M1.435 7.846c0-3.254 2.648-5.902 5.902-5.902 3.255 0 5.902 2.648 5.902 5.902 0 3.255-2.647 5.902-5.902 5.902-3.254 0-5.902-2.647-5.902-5.902m16.956 10.247l-5.517-5.51c1.092-1.276 1.754-2.93 1.754-4.737 0-4.02-3.27-7.29-7.29-7.29-4.021 0-7.292 3.27-7.292 7.29s3.27 7.291 7.291 7.291c1.714 0 3.291-.596 4.537-1.59l5.535 5.529c.136.135.313.203.49.203.179 0 .357-.068.492-.204.271-.271.271-.71 0-.982"
                        transform="translate(-320 -16) translate(320 16) translate(3 2)"
                      ></path>
                    </g>
                  </g>
                </g>
